...
\begin{example}[la normale sur $\R$] %TODO Add it
\end{example}
...
\begin{proof}
	\begin{itemize}
		...
		\item $f= 0 \ \mu-pp \rightarrow \int f d\mu = 0$ \\ %TODO: add reference to separation
...
\begin{theorem}[Égalité Reinmann-Lebesgue sur un segment, foctions positives]
	Soit $f$ mesurable positive:
